...
$config['domain_name']          = 'codenimbly.compudeluxe.dev';
$config['www_domain_name']      = 'codenimbly.compudeluxe.dev';
$config['site_url']             = "{$config['protocol']}://codenimbly.compudeluxe.dev"; 
$config['base_url']             = "{$config['protocol']}://codenimbly.compudeluxe.dev/";
$config['static_url']           = "{$config['protocol']}://codenimbly.compudeluxe.dev/static/"; // Static content URL (cookieless sub domain RECOMMENDED)

$config['images_url']           = $config['static_url'] . "assets/images/"; 
$config['css_url']              = $config['static_url'] . "assets/css/"; 
$config['js_url']               = $config['static_url'] . "assets/js/"; 
$config['third_party_url']      = $config['static_url'] . "assets/third_party/"; 
...
$config['meta_keywords']        = "codenimby, compudeluxe, framework";
